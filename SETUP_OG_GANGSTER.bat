...
echo.
echo ======================================================
echo   OG-AI SUPREME AGENT SETUP - GANGSTER MODE ACTIVATED! 
echo ======================================================
echo.
echo Yo, installing the most intelligent AI agent ever...
echo.

REM Check for Python
python --version >nul 2>&1
if errorlevel 1 (
    echo ERROR: Python ain't installed, bruh! Get that shit first!
...
echo    python og_supreme_agent.py
echo.
echo FEATURES:
